...
me = LINE("kumard18733@gmail.com","abi.singh66")
me.log("Auth Token : " + str(me.authToken))



kk1 = LINE("nisaralam0245@gmail.com","abi.singh66")
kk1.log("Auth Token : " + str(kk1.authToken))



kk2 = LINE("ajayy5916@gmail.com","abi.singh66")
kk2.log("Auth Token : " + str(kk2.authToken))



kk3 = LINE("ajay991876@gmail.com","abi.singh66")
kk3.log("Auth Token : " + str(kk3.authToken))



kk4 = LINE("sy4412043@gmail.com","abi.singh66")
kk4.log("Auth Token : " + str(kk4.authToken))



jss = LINE("rohitrajput596@gmail.com","abi.singh66")
